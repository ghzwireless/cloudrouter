...
def run(test, params, env):
    ...
    cloudrouter = session.cmd("sudo dnf install -y quagga",timeout=300)
    ...
    cloudrouter = session.cmd("sudo systemctl disable zebra")
    ...
    cloudrouter = session.cmd("sudo systemctl stop zebra")
